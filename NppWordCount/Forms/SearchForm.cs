	...
	public partial class WordCountForm : Form
	{
		...
		void InitToolbar()
		{
			...
			else
			{
				...
				MaximumSize = new Size(0, frmWordCount.Size.Height);
			}
		}
		...
		public void CheckToolbarVisiblity()
		{
			...
			try
			{
				...
				band.cxMinChild = 120;
				band.cyMinChild = frmWordCount.Height;
				band.cyMaxChild = frmWordCount.Height;
				band.cyChild 	= 0;
				band.cyIntegral = 0;
				...
				Win32.SendMessage(txtWordCount.Handle, (NppMsg)Win32.EM_SETCUEBANNER, 0, "Search Menu & Preferences (Ctrl+M)");
			}
			finally
			{
